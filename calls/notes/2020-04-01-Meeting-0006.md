...
2) tried his best to be scientific by asking the same questions in the same order, what would you do differently? Ask different questions, different order, etc. Will post the template for collaboration.
